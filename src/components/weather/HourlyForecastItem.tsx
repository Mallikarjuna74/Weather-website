...
const HourlyForecastItem = () => {
  return (
    <>
      <div className="flex justify-between items-center p-4 w-90 h-14 md:w-full rounded-lg bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs">
