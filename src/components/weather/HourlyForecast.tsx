...
const HourlyForecast = () => {
  ...
  return (
    <>
      ...
      flex flex-col"
      >
        <div className="flex justify-between items-center p-4 pb-0 relative"> 
          ...
          {open && (
            <div className="absolute top-full right-0 mt-1 w-40 bg-gray-800 backdrop-blur-md border border-white/20 rounded-lg shadow-lg z-10">
