const Navbar = () => {
  return (
    <div className="navbar flex justify-between items-center sm:px-6 md:px-12 lg:px-4 py-4">
        <div>
            <img src="src/assets/images/logo.svg" alt="logo" className="w-36 sm:w-46 md:w-56 lg:w-56 xl:96 2xl:126"/>
        </div>
        <div>
            ...
            sm:w-46 md:w-46 md:items-center lg:w-40"
            >
