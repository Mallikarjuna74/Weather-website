...
const Navbar = () => {
  ...
  const CheckMark = () => (
    <img src="/Weather-website/images/icon-checkmark.svg" alt="selected" className="w-3 h-3" /> 
  );
  ...
  return (
    <div className="navbar flex w-full justify-between items-center px-4 py-6 md:px-8 lg:px-8 xl:px-0">
      ...
      <div>
        <img src="/Weather-website/images/logo.svg" alt="logo" className="w-36 sm:w-46 md:w-56 lg:w-56 xl:96 xl: 2xl:126"/>
      </div>
