...
> = {
  ...
  51: { icon: "/images/icon-rain.webp", label: "Light drizzle" },
  61: { icon: "/images/icon-rain.webp", label: "Rain" },
  71: { icon: "/images/icon-snow.webp", label: "Snow" },
  95: { icon: "/images/icon-storm.webp", label: "Thunderstorm" },
};
